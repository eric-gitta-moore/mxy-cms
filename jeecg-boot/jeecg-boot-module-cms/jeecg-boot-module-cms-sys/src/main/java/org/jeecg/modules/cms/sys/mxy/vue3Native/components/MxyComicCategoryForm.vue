<template>
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        <a-col :span="24">
          <a-form-item label="英文分类名" v-bind="validateInfos.nameEng">
            <a-input v-model:value="formData.nameEng" placeholder="请输入英文分类名" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="分类名" v-bind="validateInfos.name">
            <a-input v-model:value="formData.name" placeholder="请输入分类名" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="排序优先级" v-bind="validateInfos.sort">
	          <a-input-number v-model:value="formData.sort" placeholder="请输入排序优先级" style="width: 100%" :disabled="disabled"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
<script lang="ts" setup>
  ...
  import {loadTreeData, saveOrUpdateDict} from '../MxyComicCategory.api';
