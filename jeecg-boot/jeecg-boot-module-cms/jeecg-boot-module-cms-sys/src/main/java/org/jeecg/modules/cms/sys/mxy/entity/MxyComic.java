 ...
 * @Version: V1.0
 */
@ApiModel(value="mxy_comic对象", description="漫画列表")
@Data
@TableName("mxy_comic")
public class MxyComic implements Serializable {
	...
	/**所属分类*/
	@Excel(name = "所属分类", width = 15, dictTable = "mxy_comic_category", dicText = "name", dicCode = "id")
    @Dict(dictTable = "mxy_comic_category", dicText = "name", dicCode = "id")
	...
	/**作者账号*/
	@Excel(name = "作者账号", width = 15, dictTable = "sys_user", dicText = "realname", dicCode = "id")
