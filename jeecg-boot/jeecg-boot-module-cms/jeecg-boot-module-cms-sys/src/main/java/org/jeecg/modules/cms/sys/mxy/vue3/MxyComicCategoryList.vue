<template>
  <div>
    ...
    <!--字典弹窗-->
    <MxyComicCategoryModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>
...
<script lang="ts" name="mxy-mxyComicCategory" setup>
  ...
  import {columns,searchFormSchema} from './MxyComicCategory.data';
  ...
  async function handleDelete(record) {
    await deleteMxyComicCategory({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteMxyComicCategory({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
