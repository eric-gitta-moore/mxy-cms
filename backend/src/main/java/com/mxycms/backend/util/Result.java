...
public class Result<T> {
     ...
     * 用户端错误
     */
    public static <T> Result errorInUser(T data, String errorMessage) {
        Result result = new Result("A00001", data);
     ...
     * 系统执行出错
     */
    public static <T> Result errorInSystem(T data, String errorMessage) {
        Result result = new Result("B00001", data);
        result.setErrorMessage(errorMessage);
        return result;
    }
     ...
     * 调用第三方服务出错
     */
    public static <T> Result errorInRpc(T data, String errorMessage) {
        Result result = new Result("C00001", data);
        result.setErrorMessage(errorMessage);
        return result;
    }
}
